          ...
          <div class="container">
            ...
            <div class="row row-cards">
              <div class="col-6 col-sm-4 col-lg-2">
                ...
                $countProducts = mysqli_num_rows($results);
              ?>
                      <i class="fe fe-chevron-down"></i>
                    </div>
                    <div class="h1 m-0"><?php echo $countProducts; ?></div>
                    <div class="text-muted mb-4">Total Products</div>
                  </div>
                </div>
              </div>
              <div class="col-6 col-sm-4 col-lg-2">
              ...
              ?>
                    ...
                    <div class="h1 m-0"><?php echo $countProducts; ?></div>
                    <div class="text-muted mb-4">Active Products</div>
                  </div>
                </div>
              </div>
              <div class="col-6 col-sm-4 col-lg-2">
                ...
                $results = mysqli_query($connection, $sql);
                confirm_query($results);
                $countCategories = mysqli_num_rows($results);
              ?>
                      <i class="fe fe-chevron-up"></i>
                    </div>
                    <div class="h1 m-0"><?php echo $countCategories; ?></div>
                    <div class="text-muted mb-4">Total Category</div>
                  </div>
                </div>
              </div>
              <div class="col-6 col-sm-4 col-lg-2">
                <div class="card">
                  <div class="card-body p-3 text-center">
                    <div class="text-right text-red">
                      <?php
                        $sql_total_weight = "SELECT sum(total_weight) AS total FROM products WHERE active = 1";
                        $results = mysqli_query($connection, $sql_total_weight);
                        confirm_query($results);
                    ...
                    <div class="h1 m-0"><?php echo round($weight, 3); ?></div>
                    <div class="text-muted mb-4">Total Weight Avilable</div>
                  </div>
                </div>
              </div>
              <div class="col-6 col-sm-4 col-lg-2">
